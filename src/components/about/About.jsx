...
import CV from "../../assets/Resume_Vansh.pdf";
  ...
  return (
    <div>
      <section className="about section" id="about">
        ...
        <h2 className="section__subtitle">My introduction</h2>
        <div className="about__container container grid">
          ...
          <div className="about__data">
            ...
            <a download='' href={CV} className="button button--flex button-space" >Download CV
                <svg
                class="button__icon"
            ...
            <a href={CV} target="_blank" class="button button--flex button-space">View CV
                <svg
                class="button__icon"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
